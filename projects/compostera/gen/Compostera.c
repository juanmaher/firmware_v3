...
static sc_boolean check_TECX_Copy_1_VALIDACION_tr1_tr1(const Compostera* handle);
...
static sc_boolean check_LED3_ESPERANDO_tr0_tr0(const Compostera* handle);
static sc_boolean check_LED3_ESPERANDO_tr1_tr1(const Compostera* handle);
static sc_boolean check_LED3_ESPERANDO_tr2_tr2(const Compostera* handle);
static sc_boolean check_LED3_ESPERANDO_tr3_tr3(const Compostera* handle);
static sc_boolean check_LED3_ENFRIANDO_tr0_tr0(const Compostera* handle);
static sc_boolean check_LED3_ENFRIANDO_tr1_tr1(const Compostera* handle);
static sc_boolean check_LED3_HUMEDECIENDO_tr0_tr0(const Compostera* handle);
static sc_boolean check_LED3_HUMEDECIENDO_tr1_tr1(const Compostera* handle);
static sc_boolean check_LED3_DESHUMEDECIENDO_tr0_tr0(const Compostera* handle);
static sc_boolean check_LED3_DESHUMEDECIENDO_tr1_tr1(const Compostera* handle);
static sc_boolean check_LED3_COMPOSTANDO_r1_RELLENANDO_tr0_tr0(const Compostera* handle);
static sc_boolean check_LED3_COMPOSTANDO_r1_RELLENANDO_tr1_tr1(const Compostera* handle);
static sc_boolean check_LED3_COMPOSTANDO_r1_SONANDO_tr0_tr0(const Compostera* handle);
static sc_boolean check_LED3_COMPOSTANDO_r1_MEZCLANDO_tr0_tr0(const Compostera* handle);
...
static void effect_TECX_Copy_1_VALIDACION_tr1(Compostera* handle);
...
static void effect_LED3_ESPERANDO_tr0(Compostera* handle);
static void effect_LED3_ESPERANDO_tr1(Compostera* handle);
static void effect_LED3_ESPERANDO_tr2(Compostera* handle);
static void effect_LED3_ESPERANDO_tr3(Compostera* handle);
static void effect_LED3_ENFRIANDO_tr0(Compostera* handle);
static void effect_LED3_ENFRIANDO_tr1(Compostera* handle);
static void effect_LED3_HUMEDECIENDO_tr0(Compostera* handle);
static void effect_LED3_HUMEDECIENDO_tr1(Compostera* handle);
static void effect_LED3_DESHUMEDECIENDO_tr0(Compostera* handle);
static void effect_LED3_DESHUMEDECIENDO_tr1(Compostera* handle);
static void effect_LED3_COMPOSTANDO_tr0(Compostera* handle);
static void effect_LED3_COMPOSTANDO_r1_RELLENANDO_tr0(Compostera* handle);
static void effect_LED3_COMPOSTANDO_r1_RELLENANDO_tr1(Compostera* handle);
static void effect_LED3_COMPOSTANDO_r1_SONANDO_tr0(Compostera* handle);
static void effect_LED3_COMPOSTANDO_r1_MEZCLANDO_tr0(Compostera* handle);
...
static void enact_LED3_ESPERANDO(Compostera* handle);
static void enact_LED3_ENFRIANDO(Compostera* handle);
static void enact_LED3_HUMEDECIENDO(Compostera* handle);
static void enact_LED3_DESHUMEDECIENDO(Compostera* handle);
static void enact_LED3_COMPOSTANDO_r1_RELLENANDO(Compostera* handle);
static void enact_LED3_COMPOSTANDO_r1_SONANDO(Compostera* handle);
static void enact_LED3_COMPOSTANDO_r1_MEZCLANDO(Compostera* handle);
...
static void exact_LED3_COMPOSTANDO_r1_RELLENANDO(Compostera* handle);
static void exact_LED3_COMPOSTANDO_r1_MEZCLANDO(Compostera* handle);
...
static void enseq_LED3_ESPERANDO_default(Compostera* handle);
static void enseq_LED3_ENFRIANDO_default(Compostera* handle);
static void enseq_LED3_HUMEDECIENDO_default(Compostera* handle);
static void enseq_LED3_DESHUMEDECIENDO_default(Compostera* handle);
static void enseq_LED3_COMPOSTANDO_default(Compostera* handle);
static void enseq_LED3_COMPOSTANDO_r1_RELLENANDO_default(Compostera* handle);
static void enseq_LED3_COMPOSTANDO_r1_SONANDO_default(Compostera* handle);
static void enseq_LED3_COMPOSTANDO_r1_MEZCLANDO_default(Compostera* handle);
static void enseq_TECX_default(Compostera* handle);
static void enseq_main_region_default(Compostera* handle);
static void enseq_LED3_default(Compostera* handle);
static void enseq_LED3_COMPOSTANDO_r1_default(Compostera* handle);
...
static void exseq_LED3_ESPERANDO(Compostera* handle);
static void exseq_LED3_ENFRIANDO(Compostera* handle);
static void exseq_LED3_HUMEDECIENDO(Compostera* handle);
static void exseq_LED3_DESHUMEDECIENDO(Compostera* handle);
static void exseq_LED3_COMPOSTANDO(Compostera* handle);
static void exseq_LED3_COMPOSTANDO_r1_RELLENANDO(Compostera* handle);
static void exseq_LED3_COMPOSTANDO_r1_SONANDO(Compostera* handle);
static void exseq_LED3_COMPOSTANDO_r1_MEZCLANDO(Compostera* handle);
static void exseq_TECX(Compostera* handle);
static void exseq_main_region(Compostera* handle);
static void exseq_LED3(Compostera* handle);
static void exseq_LED3_COMPOSTANDO_r1(Compostera* handle);
...
static void react_LED3_ESPERANDO(Compostera* handle);
static void react_LED3_ENFRIANDO(Compostera* handle);
static void react_LED3_HUMEDECIENDO(Compostera* handle);
static void react_LED3_DESHUMEDECIENDO(Compostera* handle);
static void react_LED3_COMPOSTANDO_r1_RELLENANDO(Compostera* handle);
static void react_LED3_COMPOSTANDO_r1_SONANDO(Compostera* handle);
static void react_LED3_COMPOSTANDO_r1_MEZCLANDO(Compostera* handle);
static void react_TECX__entry_Default(Compostera* handle);
static void react_main_region__entry_Default(Compostera* handle);
static void react_LED3__entry_Default(Compostera* handle);
static void react_LED3_COMPOSTANDO_r1__entry_Default(Compostera* handle);
static void react_LED3_COMPOSTANDO_r1__exit_Default(Compostera* handle);
...
void compostera_runCycle(Compostera* handle)
{
	...
	for (handle->stateConfVectorPosition = 0;
		...
		case Compostera_LED3_ESPERANDO:
		{
			react_LED3_ESPERANDO(handle);
			break;
		}
		case Compostera_LED3_ENFRIANDO:
		{
			react_LED3_ENFRIANDO(handle);
			break;
		}
		case Compostera_LED3_HUMEDECIENDO:
		{
			react_LED3_HUMEDECIENDO(handle);
			break;
		}
		case Compostera_LED3_DESHUMEDECIENDO:
		{
			react_LED3_DESHUMEDECIENDO(handle);
			break;
		}
		case Compostera_LED3_COMPOSTANDO_r1_RELLENANDO:
		{
			react_LED3_COMPOSTANDO_r1_RELLENANDO(handle);
			break;
		}
		case Compostera_LED3_COMPOSTANDO_r1_SONANDO:
		{
			react_LED3_COMPOSTANDO_r1_SONANDO(handle);
			break;
		}
		case Compostera_LED3_COMPOSTANDO_r1_MEZCLANDO:
		{
			react_LED3_COMPOSTANDO_r1_MEZCLANDO(handle);
			break;
		}
		default:
			break;
...
sc_boolean compostera_isStateActive(const Compostera* handle, ComposteraStates state)
{
	...
	switch (state)
	{
		...
		case Compostera_main_region_ESPERA :
			...
			break;
		case Compostera_LED3_ESPERANDO :
			result = (sc_boolean) (handle->stateConfVector[SCVI_COMPOSTERA_LED3_ESPERANDO] == Compostera_LED3_ESPERANDO
			);
			break;
		case Compostera_LED3_ENFRIANDO :
			result = (sc_boolean) (handle->stateConfVector[SCVI_COMPOSTERA_LED3_ENFRIANDO] == Compostera_LED3_ENFRIANDO
			);
			break;
		case Compostera_LED3_HUMEDECIENDO :
			result = (sc_boolean) (handle->stateConfVector[SCVI_COMPOSTERA_LED3_HUMEDECIENDO] == Compostera_LED3_HUMEDECIENDO
			);
			break;
		case Compostera_LED3_DESHUMEDECIENDO :
			result = (sc_boolean) (handle->stateConfVector[SCVI_COMPOSTERA_LED3_DESHUMEDECIENDO] == Compostera_LED3_DESHUMEDECIENDO
			);
			break;
		case Compostera_LED3_COMPOSTANDO :
			result = (sc_boolean) (handle->stateConfVector[SCVI_COMPOSTERA_LED3_COMPOSTANDO] >= Compostera_LED3_COMPOSTANDO
				&& handle->stateConfVector[SCVI_COMPOSTERA_LED3_COMPOSTANDO] <= Compostera_LED3_COMPOSTANDO_r1_MEZCLANDO);
			break;
		case Compostera_LED3_COMPOSTANDO_r1_RELLENANDO :
			result = (sc_boolean) (handle->stateConfVector[SCVI_COMPOSTERA_LED3_COMPOSTANDO_R1_RELLENANDO] == Compostera_LED3_COMPOSTANDO_r1_RELLENANDO
			);
			break;
		case Compostera_LED3_COMPOSTANDO_r1_SONANDO :
			result = (sc_boolean) (handle->stateConfVector[SCVI_COMPOSTERA_LED3_COMPOSTANDO_R1_SONANDO] == Compostera_LED3_COMPOSTANDO_r1_SONANDO
			);
			break;
		case Compostera_LED3_COMPOSTANDO_r1_MEZCLANDO :
			result = (sc_boolean) (handle->stateConfVector[SCVI_COMPOSTERA_LED3_COMPOSTANDO_R1_MEZCLANDO] == Compostera_LED3_COMPOSTANDO_r1_MEZCLANDO
			);
			break;
		default:
			result = bool_false;
...
static void clearInEvents(Compostera* handle)
{
	...
	handle->timeEvents.compostera_LED3_COMPOSTANDO_r1_RELLENANDO_tev0_raised = bool_false;
	handle->timeEvents.compostera_LED3_COMPOSTANDO_r1_MEZCLANDO_tev0_raised = bool_false;
}
...
static sc_boolean check_main_region_ESPERA_tr2_tr2(const Compostera* handle)
{
	return ((handle->internal.siTECXNoOK_raised) && (handle->internal.viTecla == COMPOSTERA_COMPOSTERAIFACE_TEC1)) ? bool_true : bool_false;
}

static sc_boolean check_main_region_ESPERA_tr3_tr3(const Compostera* handle)
{
	return ((handle->internal.siTECXOK_raised) && (handle->internal.viTecla == COMPOSTERA_COMPOSTERAIFACE_TEC1)) ? bool_true : bool_false;
}
...
static sc_boolean check_LED3_COMPOSTANDO_r1_RELLENANDO_tr0_tr0(const Compostera* handle)
{
	return handle->timeEvents.compostera_LED3_COMPOSTANDO_r1_RELLENANDO_tev0_raised;
}
...
static sc_boolean check_LED3_COMPOSTANDO_r1_MEZCLANDO_tr0_tr0(const Compostera* handle)
{
	return handle->timeEvents.compostera_LED3_COMPOSTANDO_r1_MEZCLANDO_tev0_raised;
}
...
static void effect_LED3_ESPERANDO_tr0(Compostera* handle)
{
	exseq_LED3_ESPERANDO(handle);
	enseq_LED3_ENFRIANDO_default(handle);
}

static void effect_LED3_ESPERANDO_tr1(Compostera* handle)
{
	exseq_LED3_ESPERANDO(handle);
	enseq_LED3_HUMEDECIENDO_default(handle);
}

static void effect_LED3_ESPERANDO_tr2(Compostera* handle)
{
	exseq_LED3_ESPERANDO(handle);
	enseq_LED3_DESHUMEDECIENDO_default(handle);
}

static void effect_LED3_ESPERANDO_tr3(Compostera* handle)
{
	exseq_LED3_ESPERANDO(handle);
	enseq_LED3_COMPOSTANDO_default(handle);
}

static void effect_LED3_ENFRIANDO_tr0(Compostera* handle)
{
	exseq_LED3_ENFRIANDO(handle);
	enseq_LED3_ESPERANDO_default(handle);
}
...
static void effect_LED3_HUMEDECIENDO_tr0(Compostera* handle)
{
	exseq_LED3_HUMEDECIENDO(handle);
	enseq_LED3_ESPERANDO_default(handle);
}
...
static void effect_LED3_DESHUMEDECIENDO_tr0(Compostera* handle)
{
	exseq_LED3_DESHUMEDECIENDO(handle);
	enseq_LED3_ESPERANDO_default(handle);
}
...
static void effect_LED3_COMPOSTANDO_tr0(Compostera* handle)
{
	exseq_LED3_COMPOSTANDO(handle);
	enseq_LED3_ESPERANDO_default(handle);
}

static void effect_LED3_COMPOSTANDO_r1_RELLENANDO_tr0(Compostera* handle)
{
	exseq_LED3_COMPOSTANDO_r1_RELLENANDO(handle);
	enseq_LED3_COMPOSTANDO_r1_SONANDO_default(handle);
}

static void effect_LED3_COMPOSTANDO_r1_RELLENANDO_tr1(Compostera* handle)
{
	exseq_LED3_COMPOSTANDO_r1_RELLENANDO(handle);
	enseq_LED3_COMPOSTANDO_r1_MEZCLANDO_default(handle);
}

static void effect_LED3_COMPOSTANDO_r1_SONANDO_tr0(Compostera* handle)
{
	exseq_LED3_COMPOSTANDO_r1_SONANDO(handle);
	enseq_LED3_COMPOSTANDO_r1_MEZCLANDO_default(handle);
}

static void effect_LED3_COMPOSTANDO_r1_MEZCLANDO_tr0(Compostera* handle)
{
	exseq_LED3_COMPOSTANDO_r1_MEZCLANDO(handle);
	react_LED3_COMPOSTANDO_r1__exit_Default(handle);
}
...
static void enact_TECX_NO_OPRIMIDO(Compostera* handle)
{
	...
	handle->internal.viTecla = handle->iface.evTECXNoOprimido_value;
}
...
{
	/* Entry action for state 'RELLENANDO'. */
	compostera_setTimer(handle, (sc_eventid) &(handle->timeEvents.compostera_LED3_COMPOSTANDO_r1_RELLENANDO_tev0_raised) , 1 * 1000, bool_false);
...
{
	/* Entry action for state 'MEZCLANDO'. */
	compostera_setTimer(handle, (sc_eventid) &(handle->timeEvents.compostera_LED3_COMPOSTANDO_r1_MEZCLANDO_tev0_raised) , 2 * 1000, bool_false);
...
{
	/* Exit action for state 'RELLENANDO'. */
	compostera_unsetTimer(handle, (sc_eventid) &(handle->timeEvents.compostera_LED3_COMPOSTANDO_r1_RELLENANDO_tev0_raised) );		
}
...
{
	/* Exit action for state 'MEZCLANDO'. */
	compostera_unsetTimer(handle, (sc_eventid) &(handle->timeEvents.compostera_LED3_COMPOSTANDO_r1_MEZCLANDO_tev0_raised) );		
}
...
static void enseq_TECX_DEBOUNCE_default(Compostera* handle)
{
	...
	handle->stateConfVector[0] = Compostera_TECX_DEBOUNCE;
	handle->stateConfVectorPosition = 0;
}
...
{
	/* 'default' enter sequence for state ESPERA */
	handle->stateConfVector[0] = Compostera_TECX_ESPERA;
	handle->stateConfVectorPosition = 0;
}
...
static void enseq_TECX_OPRIMIDO_default(Compostera* handle)
{
	...
	handle->stateConfVector[0] = Compostera_TECX_OPRIMIDO;
	handle->stateConfVectorPosition = 0;
}
...
{
	/* 'default' enter sequence for state VALIDACION */
	handle->stateConfVector[0] = Compostera_TECX_VALIDACION;
	handle->stateConfVectorPosition = 0;
}
...
static void enseq_TECX_NO_OPRIMIDO_default(Compostera* handle)
{
	...
	handle->stateConfVector[0] = Compostera_TECX_NO_OPRIMIDO;
	handle->stateConfVectorPosition = 0;
}
...
static void enseq_TECX_Copy_1_DEBOUNCE_default(Compostera* handle)
{
	...
	handle->stateConfVector[0] = Compostera_TECX_Copy_1_DEBOUNCE;
	handle->stateConfVectorPosition = 0;
}
...
{
	/* 'default' enter sequence for state Copy_1_VALIDACION */
	handle->stateConfVector[0] = Compostera_TECX_Copy_1_VALIDACION;
	handle->stateConfVectorPosition = 0;
}
...
{
	/* 'default' enter sequence for state ESPERA */
	handle->stateConfVector[1] = Compostera_main_region_ESPERA;
...
{
	/* 'default' enter sequence for state ESPERANDO */
	enact_LED3_ESPERANDO(handle);
	handle->stateConfVector[2] = Compostera_LED3_ESPERANDO;
...
{
	/* 'default' enter sequence for state ENFRIANDO */
	enact_LED3_ENFRIANDO(handle);
	handle->stateConfVector[2] = Compostera_LED3_ENFRIANDO;
	handle->stateConfVectorPosition = 2;
}
...
{
	/* 'default' enter sequence for state HUMEDECIENDO */
	enact_LED3_HUMEDECIENDO(handle);
	handle->stateConfVector[2] = Compostera_LED3_HUMEDECIENDO;
	handle->stateConfVectorPosition = 2;
}
...
{
	/* 'default' enter sequence for state DESHUMEDECIENDO */
	enact_LED3_DESHUMEDECIENDO(handle);
	handle->stateConfVector[2] = Compostera_LED3_DESHUMEDECIENDO;
	handle->stateConfVectorPosition = 2;
}
...
{
	/* 'default' enter sequence for state COMPOSTANDO */
	enseq_LED3_COMPOSTANDO_r1_default(handle);
}
...
{
	/* 'default' enter sequence for state RELLENANDO */
	enact_LED3_COMPOSTANDO_r1_RELLENANDO(handle);
	handle->stateConfVector[2] = Compostera_LED3_COMPOSTANDO_r1_RELLENANDO;
	handle->stateConfVectorPosition = 2;
}
...
{
	/* 'default' enter sequence for state SONANDO */
	enact_LED3_COMPOSTANDO_r1_SONANDO(handle);
	handle->stateConfVector[2] = Compostera_LED3_COMPOSTANDO_r1_SONANDO;
	handle->stateConfVectorPosition = 2;
}
...
{
	/* 'default' enter sequence for state MEZCLANDO */
	enact_LED3_COMPOSTANDO_r1_MEZCLANDO(handle);
	handle->stateConfVector[2] = Compostera_LED3_COMPOSTANDO_r1_MEZCLANDO;
	handle->stateConfVectorPosition = 2;
}
...
{
	/* 'default' enter sequence for region r1 */
	react_LED3_COMPOSTANDO_r1__entry_Default(handle);
}
...
{
	/* Default exit sequence for state COMPOSTANDO */
	exseq_LED3_COMPOSTANDO_r1(handle);
}
...
static void exseq_LED3_COMPOSTANDO_r1_RELLENANDO(Compostera* handle)
{
	...
	handle->stateConfVector[2] = Compostera_last_state;
	handle->stateConfVectorPosition = 2;
	exact_LED3_COMPOSTANDO_r1_RELLENANDO(handle);
}
...
static void exseq_LED3_COMPOSTANDO_r1_MEZCLANDO(Compostera* handle)
{
	...
	handle->stateConfVector[2] = Compostera_last_state;
	handle->stateConfVectorPosition = 2;
	exact_LED3_COMPOSTANDO_r1_MEZCLANDO(handle);
}
...
{
	/* Default exit sequence for region TECX */
	/* Handle exit of all possible states (of compostera.TECX) at position 0... */
...
{
	/* Default exit sequence for region main region */
	/* Handle exit of all possible states (of compostera.main_region) at position 1... */
...
{
	/* Default exit sequence for region LED3 */
	/* Handle exit of all possible states (of compostera.LED3) at position 2... */
...
{
	/* Default exit sequence for region r1 */
	/* Handle exit of all possible states (of compostera.LED3.COMPOSTANDO.r1) at position 2... */
	switch(handle->stateConfVector[ 2 ])
	{
		case Compostera_LED3_COMPOSTANDO_r1_RELLENANDO :
		{
...
static void react_TECX_Copy_1_VALIDACION(Compostera* handle)
{
	...
	{
		if (check_TECX_Copy_1_VALIDACION_tr1_tr1(handle) == bool_true)
		{ 
			effect_TECX_Copy_1_VALIDACION_tr1(handle);
		} 
	}
}
...
{
	/* The reactions of state ESPERANDO. */
	if (check_LED3_ESPERANDO_tr0_tr0(handle) == bool_true)
	{ 
		effect_LED3_ESPERANDO_tr0(handle);
	}  else
	{
		if (check_LED3_ESPERANDO_tr1_tr1(handle) == bool_true)
		{ 
			effect_LED3_ESPERANDO_tr1(handle);
		}  else
		{
			if (check_LED3_ESPERANDO_tr2_tr2(handle) == bool_true)
			{ 
				effect_LED3_ESPERANDO_tr2(handle);
			}  else
			{
				if (check_LED3_ESPERANDO_tr3_tr3(handle) == bool_true)
				{ 
					effect_LED3_ESPERANDO_tr3(handle);
				} 
			}
		}
	}
...
{
	/* The reactions of state ENFRIANDO. */
	if (check_LED3_ENFRIANDO_tr0_tr0(handle) == bool_true)
	{ 
		effect_LED3_ENFRIANDO_tr0(handle);
	}  else
	{
		if (check_LED3_ENFRIANDO_tr1_tr1(handle) == bool_true)
		{ 
			effect_LED3_ENFRIANDO_tr1(handle);
		} 
	}
}
...
{
	/* The reactions of state HUMEDECIENDO. */
	if (check_LED3_HUMEDECIENDO_tr0_tr0(handle) == bool_true)
	{ 
		effect_LED3_HUMEDECIENDO_tr0(handle);
	}  else
	{
		if (check_LED3_HUMEDECIENDO_tr1_tr1(handle) == bool_true)
		{ 
			effect_LED3_HUMEDECIENDO_tr1(handle);
		} 
	}
}
...
{
	/* The reactions of state DESHUMEDECIENDO. */
	if (check_LED3_DESHUMEDECIENDO_tr0_tr0(handle) == bool_true)
	{ 
		effect_LED3_DESHUMEDECIENDO_tr0(handle);
	}  else
	{
		if (check_LED3_DESHUMEDECIENDO_tr1_tr1(handle) == bool_true)
		{ 
			effect_LED3_DESHUMEDECIENDO_tr1(handle);
		} 
	}
}
...
{
	/* The reactions of state RELLENANDO. */
	if (check_LED3_COMPOSTANDO_r1_RELLENANDO_tr0_tr0(handle) == bool_true)
	{ 
		effect_LED3_COMPOSTANDO_r1_RELLENANDO_tr0(handle);
	}  else
	{
		if (check_LED3_COMPOSTANDO_r1_RELLENANDO_tr1_tr1(handle) == bool_true)
		{ 
			effect_LED3_COMPOSTANDO_r1_RELLENANDO_tr1(handle);
		} 
	}
}
...
{
	/* The reactions of state SONANDO. */
	if (check_LED3_COMPOSTANDO_r1_SONANDO_tr0_tr0(handle) == bool_true)
	{ 
		effect_LED3_COMPOSTANDO_r1_SONANDO_tr0(handle);
	} 
}
...
{
	/* The reactions of state MEZCLANDO. */
	if (check_LED3_COMPOSTANDO_r1_MEZCLANDO_tr0_tr0(handle) == bool_true)
	{ 
		effect_LED3_COMPOSTANDO_r1_MEZCLANDO_tr0(handle);
	} 
}
...
{
	/* Default react sequence for initial entry  */
	enseq_LED3_COMPOSTANDO_r1_RELLENANDO_default(handle);
}
...
{
	/* The reactions of exit default. */
	effect_LED3_COMPOSTANDO_tr0(handle);
}
